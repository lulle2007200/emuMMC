...
#define EMUSD_FILE_MAX_PARTS 16
#define EMUSD_FP_CLMT_COUNT 1024
...
typedef struct _file_based_sd_ctxt
{
	uint64_t parts;
	uint64_t part_size;
	FIL fp[EMUSD_FILE_MAX_PARTS];
	DWORD clmt[EMUSD_FILE_MAX_PARTS][EMUSD_FP_CLMT_COUNT];
	uint64_t total_sct;
}file_based_sd_ctxt;
